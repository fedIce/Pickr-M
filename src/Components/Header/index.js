    ...
    return (
        <header className="header" id="header">
            <nav className="nav container">
                <Link to="/home" className="nav_logo">Pickr</Link>

                <div className="nav_menu" id="nav_menu">
                    <ul className="nav_list grid">
                        <li className="navitem">
                            <Link to="/home" className="nav_link">
                                <Unicons.UilEstate className="nav_icon" /> Home 
                            </Link>
                        </li>

                        <li className="navitem">
                            <Link to="#" className="nav_link">
                                <Unicons.UilFile className="nav_icon" /> About Us
                            </Link>
                        </li>

                        <li className="navitem">
                            <Link to="/login" className="nav_link">
                                <Unicons.UilUser className="nav_icon" /> Sign In
                            </Link>
                        </li>

                        <li className="navitem">
                            <Link to="/signup" className="nav_link">
                                <Unicons.UilUserPlus className="nav_icon" /> Sign Up
                            </Link>
                        </li>
